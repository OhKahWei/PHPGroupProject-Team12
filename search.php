...
<div class="page">
  ...
  <input type="hidden" name="Submitted" value="true">
                                ...
                                <li class="current"><a href="Log.php">Admin Control Panel</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
...
$sql = "SELECT * FROM college_info WHERE College_Name LIKE '%$Search%' OR College_Location LIKE '%$Search%' OR College_Courses LIKE '%$Search%' ";
...
if ($queryResult > 0) {
    ...
    echo "No results found!!! There are no results matching your search!!!";
}
